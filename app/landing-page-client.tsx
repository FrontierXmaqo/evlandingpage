...
export type LeadFormOptions = {
  ...
  billRanges: string[];
  electricSupplyOptions: string[];
  languages: string[];
};

export const DEFAULT_LEAD_FORM_OPTIONS: LeadFormOptions = {
  salutations: ["Mr", "Mrs", "Ms", "Dr.", "Datin", "Dato'", "Dato' Sri", "Tun"],
  states: [
    "Selangor",
    "Kuala Lumpur",
    "Putrajaya",
  ...
  propertyTypes: [
    ...
    "Semi-detached",
    "Bungalow",
    "Apartment / Condo (landed access)",
  ],
  billRanges: ["Below RM250", "RM250–500", "RM500–800", "RM800–1,500", "Above RM1,500"],
  electricSupplyOptions: ["Single Phase", "Three Phase", "Unsure"],
            ...
            <div className="form-row form-row-name">
              <div className="field">
                ...
                <select id="fsalutation" name="fsalutation" defaultValue="" disabled={submitting}>
                  <option value="">—</option>
                  {leadFormOptions.salutations.map((opt) => (
            ...
            <div className="form-row">
              <div className="field">
                ...
                <select id="fstate" name="fstate" required defaultValue="" disabled={submitting}>
                  ...
                  {leadFormOptions.states.map((opt) => (
                    <option key={opt}>{opt}</option>
                  ))}
                </select>
              </div>
              <div className="field">
                ...
                <select id="fprop" name="fprop" required defaultValue="" disabled={submitting}>
                  ...
                  {leadFormOptions.propertyTypes.map((opt) => (
                    <option key={opt}>{opt}</option>
                  ))}
                </select>
              </div>
            ...
            <div className="form-row">
              <div className="field">
                ...
                <select id="fbill" name="fbill" required defaultValue="" disabled={submitting}>
                  ...
                  {leadFormOptions.billRanges.map((opt) => (
                    <option key={opt}>{opt}</option>
                  ))}
                </select>
              </div>
              <div className="field">
                ...
                <select id="felectric" name="felectric" defaultValue="" disabled={submitting}>
                  <option value="">—</option>
                  {leadFormOptions.electricSupplyOptions.map((opt) => (
                    <option key={opt}>{opt}</option>
                  ))}
                </select>
              </div>
              ...
              <div className="field">
                ...
                <select id="flang" name="flang" defaultValue="English" disabled={submitting}>
                  {leadFormOptions.languages.map((opt) => (
                    <option key={opt}>{opt}</option>
                  ))}
                </select>
              </div>
